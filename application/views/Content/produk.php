									...
									<table id="example1" class="table table-bordered table-striped">
										<thead>
											<tr>
												...
												<th class="text-center">Stok Supplier</th>
								...
								<form action="<?= base_url('controllerDataMaster/produk') ?>" method="POST" role="form">
									<div class="card-body">
										...
										<div class="row">
											...
											<div class="col-sm-12">
												<div class="form-group">
													<label for="exampleInputPassword1">Satuan Produk</label>
													<input type="text" name="satuan" class="form-control" value="<?= set_value('satuan') ?>" id="exampleInputPassword1" placeholder="Masukkan Satuan Produk">
											...
											<div class="col-sm-12">
												<div class="form-group">
													...
													<input type="number" name="stok_supp" class="form-control" value="<?= set_value('stok_supp') ?>" id="exampleInputPassword1" placeholder="Masukkan Stok Supplier Produk">
